...
export interface IJobApplication extends Document {
    ...
    rating?: number;
    source: string; // website, email, referral, etc.
    ipAddress?: string;
    userAgent?: string;
    createdAt: Date;
    updatedAt: Date;
...
// Static method to find by job position
JobApplicationSchema.statics.findByJobPosition = function (jobPositionId: string) {
...
JobApplicationSchema.statics.findByEmail = function (email: string) {
