...
const NewsletterCampaignSchema = new Schema<INewsletterCampaign>({
    ...
    scheduledAt: {
        type: Date,
        validate: {
            validator: function (this: INewsletterCampaign, value: Date) {
...
NewsletterCampaignSchema.virtual('deliveryRate').get(function () {
    if (this.recipients.sent === 0) return 0;
...
NewsletterCampaignSchema.statics.findByCreator = function (creatorId: string) {
...
// Instance methods
NewsletterCampaignSchema.methods.schedule = function (scheduledAt: Date) {
...
NewsletterCampaignSchema.methods.updateRecipients = function (updates: Partial<typeof this.recipients>) {
    Object.assign(this.recipients, updates);
    return this.save();
};

const NewsletterCampaign = mongoose.model<INewsletterCampaign>('NewsletterCampaign', NewsletterCampaignSchema);
